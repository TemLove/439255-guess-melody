...
const attemptsResultScreenElement = getElementFromTemplate(template);
const replayElement = attemptsResultScreenElement.querySelector(`.main-replay`);
...
export default attemptsResultScreenElement;
